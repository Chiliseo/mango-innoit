...
const directionsLimits = (direction, getState) => {
  return {
    right: () => ({
...
const changePrice = (newValue, setState, state, minPrice, maxPrice) => {
...
const getMouseDirection = (e, state, setState, setXDirection) => {
